...
Write-Host "Starting DrugOS ML Microservices..." -ForegroundColor Cyan
...
Write-Host "All 4 Phase services started on ports 8001, 8002, 8003, and 8004 in the background." -ForegroundColor Green
